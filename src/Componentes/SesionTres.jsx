...
const SesionTres = () => {
  ...
  return (
    ...
    <a-sky src="#sky" material="shader: flat;" geometry="" scale="-1.31 1 1" rotation="360 360 360"></a-sky>
     ...
     {/* luna     */}
     <a-entity id="luna"position="7.008 29.193 -52.946" rotation="0 45 0" gltf-model={luna} color="#4CC3D9"  geometry="depth:1.8900000000000001;height:1.07" scale="6.5 6.5 6.5"></a-entity>
   ...
   <a-entity position="0 0 -9" >
    ...
    <a-entity id="4"  position="3.062 -0.37 5.457">
     ...
     <a-entity id="bonsai3" position="13.711 1.528 4.185" gltf-model={bonsai} scale="2.23 3.08 3.65" rotation="0 180 0"></a-entity> 
      
    {/* terraza */}
     <a-entity>
     <a-plane  src="#grava" position="-0.493 0.058 18.949" rotation="-90.01166961505233 -0.17188733853924698 0" width="4" height="4" geometry="height:3.6900000000000004;width:3.93" scale="7.56 2.64 1.64" ></a-plane>
     <a-entity id="alfombra-terraza" position="-7.347 0.074 17.27" gltf-model={rug} rotation="0 268.28 0" scale="0.88 0.81 0.97"></a-entity>    
     <a-box src="#madera" position="5.378 0.181 16.983" rotation="-1.260507149287811 176.9293671363982 -178.76283208081685"  geometry="height:0.35;width:2.1199999999999997;depth:0.98"></a-box>
     ...
     <a-entity id="lamp" position="-12.012 0.03 15.025" rotation="0 45 0" gltf-model={lamp}  scale="0.004 0.004 0.004"></a-entity>
     <a-entity id="lamp" position="10.228 0.03 15.512" rotation="0 45 0" gltf-model={lamp}  scale="0.004 0.004 0.004"></a-entity>
     <a-entity id="book" position="5.567 0.504 17.265" rotation="14.496 2.005 0.974" gltf-model={book} color="#4CC3D9"  scale="0.03 -0.02 0.03"></a-entity>
    ...
    <a-entity id="alfombra" position="-3.415 0.002 -1.565" rotation="-0.4583662361046586 -179.564972994 0.6302535746439055" gltf-model={alfombra} color="#4CC3D9"  scale="1.29 1.2 0.98" geometry="depth:0.31;height:0"></a-entity>
    </a-entity>
    ...
    <a-box id="2" src="#madera" position="-14.85 0.092 3.834" rotation="-4.24 89.897 -0.229" geometry="width:20.8;height:1.09;depth:0.08" ></a-box>
    <a-box id="3" src="#madera" position="-0.06 -0.035 -5.888" rotation="5.042028597151244 -179.96604345059157 0.40107045659157625" geometry="width:30;height:1.09;depth:0.08" ></a-box>
    ...
    <a-animation attribute="rotation"   dur="7000"   to="0 360 0" repeat="infinity"></a-animation></a-entity>
