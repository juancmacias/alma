    ...
    return (
      <Scene xrextras-loading  physics="debug: false" canvas="" inspector="" keyboard-shortcuts="" screenshot="" vr-mode-ui="" auto-enter-vr="">
        ...
        */}
        ...
        <a-entity id="nomo_!" gltf-model={nomo} position="-14 0.01 -14" rotation="0 29 0" scale="1.2 1.2 1.2"></a-entity>
        ...
        {/* ENTRADA */}
        <a-box id="wall_seguro_1" width="30" height="3" depth="0.01" position="0 0 20" material="opacity:0.1" static-body rotation="0 180 0" ></a-box>
        <a-box id="wall_seguro_2" width="10" height="3" depth="0.01" position="15 0 15" material="opacity:0.1" static-body rotation="0 90 0" ></a-box>
        <a-box id="wall_seguro_3" width="10" height="3" depth="0.01" position="-15 0 -15" material="opacity:0.1" static-body rotation="0 -90 0" ></a-box>
        ...
        <a-plane id="plano_2" static-body position="0 -0.5 0" rotation="-90 0 0" width="300" height="400" color="green" radius="10"></a-plane>
        {/* cielo */}
